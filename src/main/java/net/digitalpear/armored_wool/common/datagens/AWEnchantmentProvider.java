...
public class AWEnchantmentProvider extends FabricDynamicRegistryProvider {
    public AWEnchantmentProvider(FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> registriesFuture) {
